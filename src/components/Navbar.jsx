...
export default function Navbar() {
  ...
  const menuLinks = [
    ...
    { name: "PROGRAMMING LANGUAGES", link: "#programminglang" },
    ...
    >
      <div className="flex items-center justify-between">
        <div className="mx-7">
          ...
          >
            O<span className={`${sticky?"text-white":"text-cyan-500"} font-semibold`}>wai</span>s
          </h4>
        </div>
        <div
          className={` ${
            sticky ? "md:bg-white/0 bg-white" : "bg-white"
          } text-gray-900 md:block hidden px-7 py-2 font-bold rounded-bl-full`}
        >
